...
package com.ttyun.recyclerviewwiki.tantan.widget.sys;
...
public class ItemTouchHelper extends RecyclerView.ItemDecoration
        ...
        if (mSelected != null) {
            ...
            if (prevSelected.itemView.getParent() != null) {
                ...
                if (animationType == ANIMATION_TYPE_SWIPE_CANCEL)
                    rv.setInterpolator(new OvershootInterpolator(3));   //  CJR add 添加差值器
    ...
    private class RecoverAnimation implements AnimatorListenerCompat {
        ...
        /**
         * CJR add 从ValueAnimator 拷贝过来的, 差值器的使用
         */
            ...
            mValueAnimator.addUpdateListener(
                    new AnimatorUpdateListenerCompat() {
                        ...
                        public void onAnimationUpdate(ValueAnimatorCompat animation) {
                            //  setFraction(animation.getAnimatedFraction());     //  original code 原来的代码
                            //  ----------- CJR change -----------
